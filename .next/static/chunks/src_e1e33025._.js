        ...
        "GalleryPage.useEffect": ()=>{
            if (activeFilter === 'all') {
                ...
                setFiltered(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$fishData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fishData"].filter({
                    "GalleryPage.useEffect": (item)=>item.category === activeFilter
                }["GalleryPage.useEffect"]));
            }
            setCurrentPage(1);
        }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: totalPages > 1 && Array.from({
                        length: totalPages
                            ...
                            onClick: ()=>setCurrentPage(index + 1),
                            className: "\n                w-10 h-10 mx-1 flex items-center justify-center font-semibold border rounded-sm transition-colors duration-300\n                ".concat(currentPage === index + 1 ? 'bg-primary text-white border-primary' : 'bg-white dark:bg-dark-surface dark:text-gray-300 text-gray-600 border-gray-200 dark:border-gray-700 hover:bg-primary/80 hover:text-white', "\n              "),
                            children: index + 1
                        }, index, false, {
                            fileName: "[project]/src/app/products/page.tsx",
                            lineNumber: 231,
...
_s(GalleryPage, "scXMZy6ER0Rg+R2bdosPinFIyHk=");
_c = GalleryPage;
...
//# sourceMappingURL=src_e1e33025._.js.map