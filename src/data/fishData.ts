...
export const fishData: Fish[] = [
  ...
  },
  {
    ...
    category: 'Crew',
    species: 'Callichthyidae',
    description: ' Scavenger fish that feed on leftover food,algae,and debris in the aquarium.They help maintain cleanliness but still require proper feeding ',
    width: 800,
    height: 400,
  },
  {
    ...
    },    
  {
    ...
    category: 'Glow',
    species: 'Cichlid',
    description: 'Malawi cichlids have many varieties with vibrant colors and unique patterns.They should not be kept with small,slow,or long-finned fish due to their aggression.Provide plenty of rocks and hiding places to help manage territorial behavior.',
    width: 800,
    height: 400,
    },
    ...
    category: 'Crew',
    species: 'Loricariidae',
    description: ' Catfish are a large group of bottom-dwelling fish,often recognized by their whisker-like barbels.Popular species,such as Corydoras and Plecos,are peaceful and valued for helping to clean algae and debris in aquariums.',
    width: 800,
    height: 300,
  },
